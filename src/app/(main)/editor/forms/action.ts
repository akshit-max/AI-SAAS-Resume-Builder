...
export async function generateSummary(input: GenerateSummaryInput) {
 ...
 if (process.env.AI_ENABLED !== "true") {
  ...
  const systemMessage = `
    ...
    Rules:
- Do NOT use buzzwords like:
  "results-driven", "highly motivated", "dynamic", "passionate", "team player"
- Write in clear, simple, factual language
- No exaggeration or marketing tone
    `;
